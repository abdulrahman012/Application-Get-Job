...
public class Detail_AmbilProjectDigitalMarketing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_detail_ambil_project_digital_marketing);
        ...
        ic_kembali.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                Intent intent = new Intent (Detail_AmbilProjectDigitalMarketing.this, My_Project.class);
        ...
        BTNAmbil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (installed){
                    ...
                    Toast.makeText(Detail_AmbilProjectDigitalMarketing.this, "Whatsapp not installed  on", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
