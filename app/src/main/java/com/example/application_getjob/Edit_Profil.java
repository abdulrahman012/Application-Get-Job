...
public class Edit_Profil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SessionManager sessionManager = new SessionManager(Edit_Profil.this);
        ...
        EditFoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bitMap != null) {
                    ...
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Edit_Profil.this);
        ...
        builder.setItems(rPilihan, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (pilihan.equals("Take a photo")) {
                    ...
                    Uri fileProvider = FileProvider.getUriForFile(Edit_Profil.this, authorities, photoFile);
                    ...
                    ActivityCompat.requestPermissions(Edit_Profil.this, new String[]
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (requestCode == REQUEST_TAKE_PHOTO) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(Edit_Profil.this, "Picture wasn't taken!", Toast.LENGTH_SHORT).show();
            }
    ...
    void validatingData(){
        if(nama.equals("") || email.equals("") || umur.equals("") || jenis_kelamin.equals("")){
            ...
            Toast.makeText(Edit_Profil.this, "Data Cannot Empty", Toast.LENGTH_SHORT).show();
        } else {
            updateData();
        }
    }
    ...
    void updateData(){
        AndroidNetworking.post("https://tkjconekc.com/mobile/api_kelompok_1/updateData.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Edit_Profil.this, "" + pesan, Toast.LENGTH_SHORT).show();
                            Log.d("status",""+status);
                            ...
                            if (status) {
                                new AlertDialog.Builder(Edit_Profil.this)
                                        ...
                                        .setPositiveButton("Back", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent i = new Intent(Edit_Profil.this, MainActivity.class);
                                                startActivity(i);
                                                Edit_Profil.this.finish();
                                            }
                                        })
                                        .show();
                            } else {
