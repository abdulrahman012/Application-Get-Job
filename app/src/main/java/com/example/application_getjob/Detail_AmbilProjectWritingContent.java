...
public class Detail_AmbilProjectWritingContent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_detail_ambil_project_writing_content);
        ...
        ic_kembali.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                Intent intent = new Intent (Detail_AmbilProjectWritingContent.this, My_Project.class);
        ...
        BTNAmbil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (installed){
                    ...
                    Toast.makeText(Detail_AmbilProjectWritingContent.this, "Whatsapp not installed  on", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
