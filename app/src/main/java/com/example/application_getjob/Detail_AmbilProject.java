...
public class Detail_AmbilProject extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_detail_ambil_project);
        ...
        ic_kembali.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                Intent intent = new Intent (Detail_AmbilProject.this, My_Project.class);
        ...
        BTNAmbil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (installed){
                    ...
                    Toast.makeText(Detail_AmbilProject.this, "Whatsapp not installed  on", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
